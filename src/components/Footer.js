		...
		<div className="row">
			...
			<div className="col-md-5">				
				...
				<ul className="footer-socil">
	      		...
	      		<div class="footer-new"><ul class="footelink"><li>COMPANY</li><li><a href="#">Contact Us</a></li><li><a href="#">Blog</a></li><li><a href="#">Career</a></li></ul><ul class="footelink"><li>USERS</li><li><a href="#">Login</a></li><li><a href="#">Register</a></li><li><a href="#">Forget Password?</a></li></ul><p class="text-center">JointPlug Pvt.Ltd. © 2012-2020</p></div>
