    ...
    return (
        <div className="tour4 step_five">
            ...
            <div className="grid_column featured value selected">
                ...
                <div className="title">Premium</div>
                    ...
                    <div className="cta">
                        <div className="trybtn">
                            <button onClick={(e) => {submit(e)}}>Try</button>
                            <button onClick={(e) => {submit(e)}}>Buy</button>
                        </div>
                ...
                <div className="cta">
                    <div className="trybtn">
                            <button color="warning" onClick={(e) => {submit(e)}}>
                                Try
                            </button>
                            <button color="warning" onClick={(e) => {submit(e)}}>
                                Buy
                ...
                <div className="cta">
                <div>
                    <button onClick={(e) => {submit(e)}}>CHOOSE</button>
                </div>
                 <span className="trial">&nbsp;</span>
                </div>
                </div>
